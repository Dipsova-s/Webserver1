...
Crop Business Process Filters
    ...
    Crop WebHelp Image With Dimensions    WC_HCM_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="HCM"]  30  0  @{sizes}[5]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_GRC_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="GRC"]  30  0  @{sizes}[6]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_IT_Icon.png     jquery=#facetcat_bp_Checkbox .label[alt="IT"]   30  0  @{sizes}[7]  17  ${False}
...
Crop Item Type Filters
    ...
    Crop WebHelp Image With Dimensions  WC_Template_filter.png  css=#facetcat_itemtype_Checkbox  30  40  @{sizes}[1]  20  ${False}
    Crop WebHelp Image With Dimensions  WC_Dashboard_filter.png  css=#facetcat_itemtype_Checkbox  30  68  @{sizes}[2]  20  ${False}
...
Crop Characteristic Filters
    ...
    Crop WebHelp Image With Dimensions  WC_Starred_filter.png  css=#facetcat_characteristics_Checkbox  30  82  @{sizes}[3]  20
