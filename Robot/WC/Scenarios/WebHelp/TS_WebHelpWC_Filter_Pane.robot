...
Crop Business Process Filters
    ...
    ...     ];
    Crop WebHelp Image With Dimensions    WC_P2P_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="P2P"]  22  0  @{sizes}[0]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_S2D_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="S2D"]  22  0  @{sizes}[1]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_O2C_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="O2C"]  22  0  @{sizes}[2]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_F2R_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="F2R"]  22  0  @{sizes}[3]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_PM_Icon.png     jquery=#facetcat_bp_Checkbox .label[alt="PM"]   22  0  @{sizes}[4]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_QM_Icon.png     jquery=#facetcat_bp_Checkbox .label[alt="QM"]   22  0  @{sizes}[5]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_HCM_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="HCM"]  22  0  @{sizes}[6]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_GRC_Icon.png    jquery=#facetcat_bp_Checkbox .label[alt="GRC"]  22  0  @{sizes}[7]  17  ${False}
    Crop WebHelp Image With Dimensions    WC_IT_Icon.png     jquery=#facetcat_bp_Checkbox .label[alt="IT"]   22  0  @{sizes}[8]  17  ${False}
