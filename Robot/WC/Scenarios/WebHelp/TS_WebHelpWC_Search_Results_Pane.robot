...
Crop Search Result
    ...
    Crop WebHelp Image With Dimensions    WC_Search_Result.png    css=#Content    0   0   ${width}    ${height}
...
Crop Search Result Icons
    ...
    Crop WebHelp Image    WC_Dashboad_Icon.png   jquery=.SearchResult:first .ResultContent .rear .icon:eq(0)    ${False}
