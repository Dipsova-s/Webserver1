...
${btnCloseHelpTextPopup}                 //span[@id='HelpTextPopup_wnd_title']/..//div/a[@class='k-button k-flat k-button-icon k-window-action']/span[@class='k-icon k-i-close icon icon-close']/..
