...
Activate Model Package
    ...
    ${data}  Set variable  {"actions":[{"action_type":"activate_package","arguments":[{"name":"model","value":"EA2_800"},{"name":"package","value":"${packageUri}"}],"approval_state":"enabled"}],"name":"${name}","start_immediately":true,"delete_after_completion":false,"enabled":true,"max_run_time":0}
