...
WizardImageFile=Support\SetupFiles\EAM4.bmp
WizardSmallImageFile=Support\SetupFiles\EALogoSmall.bmp
...
Source: "NET\Backend\DeploymentTools\bin\EveryAngle.CustomerCertificates.Installer.console.exe"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
Source: "NET\Backend\DeploymentTools\bin\EveryAngle.CustomerCertificates.dll"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
Source: "NET\Backend\DeploymentTools\bin\EveryAngle.Utilities.dll"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
Source: "NET\Backend\DeploymentTools\bin\EveryAngle.Security.dll"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
Source: "NET\Backend\DeploymentTools\bin\Newtonsoft.Json.dll"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
Source: "NET\Backend\DeploymentTools\bin\Ionic.Zip.dll"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
Source: "NET\Backend\DeploymentTools\bin\BouncyCastle.Crypto.dll"; DestDir: "{code:DataPath|Tools}"; Flags: ignoreversion; Components: webclient
...
; Escape/Unescape
Source: "EveryAngle.ODataService\packages\EveryAngle.EncryptionDecryption32.2.4.2\lib\net45\EveryAngle.EncryptionDecryption32.dll";Flags: dontcopy; Components: OData
