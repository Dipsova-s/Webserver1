...
namespace EveryAngle.ManagementConsole.Test.Controllers
{
    public class AngleWarningsTaskCreatorTests : UnitTestBase
    {
        ...
        public void AWT_TaskCreator_ShouldReturnCorrectJsonTask()
        {
            ...
            ItemSolver contentInput = new ItemSolver(WarningFix.ReplaceClass, "R2020SP4", "Internalorder", "Internalorder", "Workorder");
            ...
            // Replace field
            ItemSolver contentInput2 = new ItemSolver(WarningFix.ReplaceField, "R2020SP4", "PurchaseOrderScheduleLine", "DeliveryTimeRealizedInWorkingDays", "DeliveryTimeRealizedInWorkDays");
            ...
            //Replace reference
            ItemSolver contentInput3 = new ItemSolver(WarningFix.ReplaceField, "R2020SP4", "BillingDocumentItem", "Test_ref_Payer", "Payer__Description");
