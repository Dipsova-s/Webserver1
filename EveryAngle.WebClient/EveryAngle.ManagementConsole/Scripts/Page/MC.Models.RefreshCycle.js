    ...
    function RefreshCycle() {
        ...
        self.BindingDataToForm = function (data) {
            ...
            if (jQuery.isNumeric(data.sap_download_max_run_time)) {
                var downloadTimeStopPickerValue = MC.util.unixtimeToTimePicker(data.sap_download_max_run_time, false);
        ...
        self.GetTaskData = function () {
            ...
            if (sapDownloadMaxRunTime.val() !== '')
                taskModel.sap_download_max_run_time = MC.util.timePickerToUnixTime(sapDownloadMaxRunTime.data('kendoTimePicker').value());
