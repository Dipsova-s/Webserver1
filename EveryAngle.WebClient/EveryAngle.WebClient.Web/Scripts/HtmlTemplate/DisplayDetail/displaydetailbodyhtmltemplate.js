        ...
        '<div class="popupTabPanel" id="DisplayArea">',
            '<div id="DisplayGeneralArea">',
                ...
                '<div class="row newDisplay" data-bind="visible: IsNewDisplay()">',
                    ...
                    '<div class="input"><select class="k-dropdown tempDisplayType" id="tempDisplayType"></select></div>',
                '</div>',
                ...
                '<div class="row">',
                    ...
                    '<div class="input" id="PrivateDisplay">',
                        '<label>',
                            ...
                            '<span class="label" data-bind="css: { label: angleInfoModel.IsPublished() }"><i class="icon icon-private"></i>' + Localization.ThisIsAPrivateDisplayNotAvailableForOtherUsers + '</span>',
                        '</label>',
                    '</div>',
                '</div>',
                '<div class="row">',
                    ...
                    '<div class="input">',
                        '<label>',
                            ...
                            '<span class="label inline">' + Localization.DefaultDisplay + '</span>',
                        '</label>',
                        '<label>',
                            ...
                            '<span class="label inline">' + Localization.PersonalDefaultDisplay + '</span>',
                        '</label>',
                ...
                '<div class="row rowDefaultDrilldownDisplay" data-bind="css: { \'alwaysHide\': IsNewDisplay() || Data().display_type === enumHandlers.DISPLAYTYPE.LIST }">',
                    ...
                    '<div class="input">',
                        '<select class="k-dropdown defaultDrilldownDisplay" id="defaultDrilldownDisplay"></select>',
                    '</div>',
                '</div>',
                ...
                '<div class="row rowDisplayId">',
                    ...
                    '<div class="input">',
                        '<input id="DisplayId" type="text" required data-required-msg="Required" class="eaText eaTextSize40" data-bind="value: DisplayId, enable: Data().authorizations.update" maxlength="50" />',
                    '</div>',
                '</div>',
                '<!-- /ko -->',
            ...
            '<div class="definitionArea displayDefinitionArea" id="DisplayFilterArea">',
                ...
                '<div class="filterButtonWrapper" id="DisplayFilterButtonWrapper">',
                    '<a id="DisplayAddfilter" class="btn btn-ghost btnAddFilter" data-bind="css: displayDetailPageHandler.CanAddFilters() ? \'\' : \'disabled\', click: displayDetailPageHandler.ShowAddFilterPopup"><span data-bind="text: Localization.AddFilter">' + Localization.AddFilter + '</span></a>',
                    '<a id="AddFollowUp" class="btn btn-ghost btnAddFollowUp" data-bind="css: displayDetailPageHandler.CanAddFollowups() ? \'\' : \'disabled\', click: function (data, event) { displayDetailPageHandler.ShowFollowupPopup({ PopupFrom: enumHandlers.ANGLEPOPUPTYPE.DISPLAY }, data, event); }"><span data-bind="text: Localization.AddFollowUp">' + Localization.AddFollowUp + '</span></a>',
                '</div>',
            '</div>',
