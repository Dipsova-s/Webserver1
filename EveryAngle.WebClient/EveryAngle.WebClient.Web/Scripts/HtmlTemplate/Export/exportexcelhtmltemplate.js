var exportExcelHtmlTemplate = function () {
    return [
        '<div id="ExportOptionArea" class="popupTabPanel">',
            ...
            '</div>',
            '<div class="row" id="RefreshableData">  ',
                '<div class="field" id="RefreshableDataField">' + Captions.Label_Refreshable_data + '</div>',
                    '<div class="input">',
                        '<label for="RefreshableDataSheet">',
                            '<input type="checkbox" id="RefreshableDataSheet" onclick="exportExcelHandler.RefreshableTemplate(this)"  />',
                            '<span class="label">&nbsp;</span>',
                        '</label>',
                        '<a class="btn-info" data-role="tooltip" data-type="html" data-tooltip-text="' + Localization.RefreshableData_Info + '" data-tooltip-position="bottom" >',
            ...
            '<div class="row" id="ModeltimeStamp">',
                ...
                '<div class="input"><input type="text" id="InsertModelTimestamp" />',
            ...
            '<div class="row excel-templates" id="ExcelTemplates">',
                ...
                '<div class="input excel-template"><input type="text" id="ExcelTemplate" class="k-dropdown" /></div>',                                   
            '</div>',
            '<div class="row template-warning-message" id="template-warning-message-popup"></div>',
            '<div class="row innowera-details" id="InnoweraDetails"></div>',
