var dashboardDetailBodyHtmlTemplate = function () {
    return [
        '<ul class="popupTabMenu" id="DashboardTabs">',
            '<li class="general" onclick="dashboardDetailsHandler.TabClick(dashboardDetailsHandler.TAB.GENERAL);"><a data-bind="text: Localization.General">' + Localization.General + '</a></li>',
            '<li class="description" onclick="dashboardDetailsHandler.TabClick(dashboardDetailsHandler.TAB.DESCRIPTION);"><a data-bind="text: Localization.Description">' + Localization.Description + '</a></li>',
            '<li class="definition" onclick="dashboardDetailsHandler.TabClick(dashboardDetailsHandler.TAB.DEFINITION);"><a data-bind="text: Localization.Definition">' + Localization.Definition + '</a></li>',
            '<li class="publishing" onclick="dashboardDetailsHandler.TabClick(dashboardDetailsHandler.TAB.PUBLISHING);"><a data-bind="text: Localization.Publishing">' + Localization.Publishing + '</a></li>',
            '<li class="statistic" onclick="dashboardDetailsHandler.TabClick(dashboardDetailsHandler.TAB.STATISTIC);" data-bind="visible: !Model.IsTemporaryDashboard()"><a data-bind="    text: Localization.Statistics">' + Localization.Statistics + '</a></li>',
        '</ul>',
        '<div class="popupTabPanel" id="DashboardArea">',
            '<div class="generalArea">',
                ...
                '<div class="row">',
                    '<div class="field" data-bind="text: Localization.DashboardId">' + Localization.DashboardId + '</div>',
                    '<div class="input">',
                ...
                '<div class="row">',
                    ...
                    '<div class="input">',
                        '<label>',
                            ...
                            '<span class="label labelDashboardExecuteAtLogin" data-bind="text: Localization.ExecuteAtLogin">' + Localization.ExecuteAtLogin + '</span>',
                        '</label>',
                    '</div>',
                '</div>',
            '</div>',
