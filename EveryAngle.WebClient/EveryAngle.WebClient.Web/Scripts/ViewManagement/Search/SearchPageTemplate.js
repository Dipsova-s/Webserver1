                ...
                '<div class="SearchResult">',
                    '<div #= searchModel.GetShowRecentUseAndHideRecord(data) # >',
                        '<div class="ResultView #= searchPageHandler.GetItemIconCSSClassByDisplay(data) #">',
                            ...
                            '<a class="btn btn-display-badge btnShowDisplays" onclick="searchPageHandler.ShowDisplays(event, this, \'#= uri #\', #= searchModel.GetTotalDisplays(data) #)">',
                                '<i class="icon icon-displays"></i>',
                                '<span class="badge">#= searchModel.GetTotalDisplays(data) #</span>',
                            '</a>',
                            '# } else { #',
                        ...
                        '<div class="ResultContent">',
                            '<div class="displayNameContainer">',
                                ...
                                '</div>',
                                '<a class="name" data-showwhenneed="true" data-role="tooltip" data-tooltip-text="#: name #" data-tooltip-position="bottom"  href="#= searchModel.GetHrefUri(data, enumHandlers.DISPLAYTYPE_EXTRA.DEFAULT) #" onclick="return #= searchModel.CheckNoDisplay(data) #">#: name #</a>',
                                '<div class="rear">',
                            ...
                            '<div class="item-label-wrapper text-ellipsis">#= searchModel.GetTags(data) #</div>',
                            '<div class="Date text-ellipsis">#= searchModel.GetCreatedItemDetail(data) # #= searchPageHandler.GetPrivateNoteByUserSpecific(data, false) #</div>',
                        '</div>',
                    '</div>',
