                ...
                '<ul class="dashboardFilterItems" data-bind="foreach: { data: FilterNodes, as: \'filterNode\' }">',
                    '<li data-bind="css: { collapsed: filterNode.collapsed, expanded: !filterNode.collapsed() }">',
                        '<div class="dashboardFilterItemHeader">',
                            ...
                            '</div>',
                            '<div class="dashboardFilterHeaderTitle textEllipsis" data-bind="text: $root.GetFilterHeader(filterNode), attr: { title: $root.GetFilterHeader(filterNode) }"></div>',
                        '</div>',
                        '<ul class="dashboardFilterItemList" data-bind="foreach: { data: filterNode.filters, as: \'filter\' }">',
                            '<li>',
                                '<div class="dashboardFilterItemHeader">',
                                    ...
                                    '</div>',
                                    '<div class="dashboardFilterHeaderTitle textEllipsis" data-bind="text: $root.GetFilterText(filter, filterNode.field), attr: { title: $root.GetFilterText(filter, filterNode.field) }"></div>',
                                '</div>',
                            '</li>',
                        '</ul>',
                    '</li>',
