function WidgetFilterView(handler) {
    ...
    self.TEMPLATECRITERIA = {
        ...
        CRITERIAGROUPTHREE: [
            ...
            '<a id="AddSelectedValue-{Index}" type="button" value="Add" class="btn btnAdd" title="Add" data-click="$root.View.AddSelectedValue({Index}, \'{DataType}\');" />',
            '<a id="RemoveSelectedValue-{Index}" type="button" value="Remove" class="btn btnRemove" title="Remove" data-click="$root.View.RemoveSelectedValue({Index}, \'{DataType}\');" />',
            '<a id="RemoveAllSelectedValue-{Index}"type="button" value="RemveAll" class="btn btnRemoveAll" title="Remove all" data-click="$root.View.RemoveAllSelectedValue({Index});" />',
            '</div>',
            '<div class="filterInputGroup1 filterInputGroupAutoResizing">',
