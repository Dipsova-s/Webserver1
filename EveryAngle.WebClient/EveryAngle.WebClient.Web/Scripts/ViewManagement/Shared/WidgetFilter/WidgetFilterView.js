function WidgetFilterView(handler) {
    ...
    self.TEMPLATECRITERIA = {
        ...
        CRITERIAGROUPTHREE: [
            ...
            '<a id="AddSelectedValue-{Index}" type="button" value="Add" class="btn btnAdd" data-role="tooltip" data-tooltip-title="Add" data-tooltip-position="bottom" data-click="$root.View.AddSelectedValue({Index}, \'{DataType}\');" />',
            '<a id="RemoveSelectedValue-{Index}" type="button" value="Remove" class="btn btnRemove" data-role="tooltip" data-tooltip-title="Remove" data-tooltip-position="bottom"  data-click="$root.View.RemoveSelectedValue({Index}, \'{DataType}\');" />',
            '<a id="RemoveAllSelectedValue-{Index}"type="button" value="RemveAll" class="btn btnRemoveAll" data-role="tooltip" data-tooltip-title="Remove all" data-tooltip-position="bottom"  data-click="$root.View.RemoveAllSelectedValue({Index});" />',
            '</div>',
            '<div class="filterInputGroup1 filterInputGroupAutoResizing">',
